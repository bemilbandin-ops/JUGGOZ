...
export const PATTERN_PRESETS: PatternPreset[] = [
  ...
  { id: 'pixel-mosaic', name: 'Club Echo', category: 'geometric', geometry: 'tight real-club afterimage stack', description: 'A compact sequence of real cropped club snapshots follows each throw with a clean, slow fade and no geometric tiles.' },
